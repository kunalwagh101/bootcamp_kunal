"""
No.15 
Batch Insertion: Implement a method in the Product class for batch insertion of multiple products.
The method should accept a list of product tuples and insert them all in one transaction.
"""
...
class Product:
    ...
    def fetch_prod_categories(self):
        """
        Fetch products along with their category names using a join query.
        Products without a category will have a NULL value for category_name.
        """
        try:
            self.cursor.execute('''
...
if __name__ == '__main__':
    ...
    print("Listing all products before batch insertion:")
    p.list_products()
    ...
    p.batch_insert_products(batch_products)

    print("\nListing all products after batch insertion:")
    p.list_products()
