"""
No.12
Join Queries: Create a new table categories and write a query to fetch products with their categories.
Implement a method in the Product class to execute this join query.
"""
...
if __name__ == '__main__':
    ...
    for prod in p.fetch_products_with_categories():
        print(prod)
