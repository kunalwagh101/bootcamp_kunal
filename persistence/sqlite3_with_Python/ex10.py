"""
Data Validation: Implement data validation in the Product class before inserting or updating records.
Ensure that name is a string and price is a positive number.
"""
